...
//  oop === object oriented programing(complex websites)
//  class , object , inhertance , abstraction, models ,
//  code ,

//  html , js , css
//  portoflio ,
//   name, work , eduction , exprience , services

//  complex ,
//  eccommerce ,= product == clothes , elctronics , shoes
//  IMG, price, rating, reviews, size
//  img, price, rating, reviews, model, capcity
...
class mainclass {
    constructor(a, b, c) {
        this.name = a; this.course = b; this.post = c;
        console.log("main ", this)
    }
    box() {
        console.log("main box method")
        return "helllo world"
    }
}
class child extends mainclass {
    constructor(a, b, c) {
        super(a, b, c);
        console.log("hello child construttor ", this)
    }
    box() {
        super.box()
        console.log("this is box child method ", super.box())
    }
}

//inheritance  in classes
// let obj2 = new mainclass("ram2", "BCA2", "manager2")
// let obj = new child("ram", "BCA", "manager");
// obj.box();
// document.getElementById("section").innerHTML = obj.box();

// let newobj = new mainclass("aman", "BTech", "developer");
// document.getElementById("section2").innerHTML = newobj.box() ;
